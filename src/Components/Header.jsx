...
const Header = () => {
  return (
    <div id="intro_container" className="nav-link home">
      <div id="intro_text_container">
            ...
            <p id="typewriter"><Typewriter
             ...
             <div id="Info_btns">
              <button id="contact-github"><a href="https://github.com/code0403" target={'_blank'} rel="noreferrer">GitHub <VscGithub /> </a></button>
              <button id="contact-linkedin"><a href="https://www.linkedin.com/in/abhishek-singh04/" target={'_blank'} rel="noreferrer">Linkedin <FaLinkedin /> </a></button>
              <button id="resume-button-1" className="nav-link resume"><a className="nav-link resume" href="https://drive.google.com/file/d/1sDOnlaTapJ8dZyh2Y5-l54sGB52u1pHG/view?usp=share_link" targert= {"_blank"} rel="noreferrer" download = "https://drive.google.com/file/d/1sDOnlaTapJ8dZyh2Y5-l54sGB52u1pHG/view?usp=share_link"> Resume <FiDownload /> </a></button>
             </div>
            
        </div>

      <div id="pic_container">
        <img id="my_pic" className="" src={pic} alt="Abhishek Singh" />
      </div>
    </div>
  );
};
