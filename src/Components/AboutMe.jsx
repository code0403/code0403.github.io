...
const AboutMe = () => {
  ...
  return (
    <div id='about' className="about section" >
      ...
      <button id="resume_btn" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="3000"><a  id="resume-link-2" className="nav-link resume"  href={Abhishek_Singh_Resume} targert= {"_blank"} rel="noreferrer" download="Abhishek_Singh_Resume"> Resume <FiDownload /> </a></button>
      </div>
    </div>
  )
}
