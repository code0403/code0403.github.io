...
const AboutMe = () => {
  ...
  return (
    <div id='about' className="nav-link about" >
      ...
      <button id="resume-button-2" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="3000"><a className="nav-link resume"  href={Abhishek_Singh_Resume} targert= {"_blank"} rel="noreferrer" download="Abhishek_Singh_Resume"> Resume <FiDownload /> </a></button>
      </div>
    </div>
  )
}
