    ...
    <div className='navbar'>
       ...
       <div id="nav-menu">
         <ul>
            ...
            <li id="resume-button-1"> <a className='nav-link resume' id='resume-link-1' href={Abhishek_Singh_Resume}   onClick={() => window.open(Abhishek_Singh_Resume)} download={Abhishek_Singh_Resume}>RESUME</a> </li>
            <div> <FontAwesomeIcon icon={ faBars }  id="toggle-icon" /> </div>
         </ul>
       </div>
